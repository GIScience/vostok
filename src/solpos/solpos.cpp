 ...
 *
 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
static int month_days[2][13] = { { 0, 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334 }, { 0, 0, 31, 60, 91, 121,
...
static void tst(struct posdata *pdat) {
	...
	pdat->tstfix = pdat->tst - (float) pdat->hour * 60.0 - pdat->minute - (float) pdat->second / 60.0
